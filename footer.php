            ...
            <div class="container pt-md-4">
                <div class="row footer-top-29">
                    <div class="col-lg-4 col-md-6 footer-list-29">
                        ...
                        <p class="mb-2 pe-xl-5">Address : 120 Okigwe Road, FGGC Bus Stop Owerri Imo State
                        Nigeria
                        </p>

                        <p class="mb-2">Phone Number : <a href="tel:+1(21) 234 4567">+2348035424726</a></p>
                    ...
                    <div class="col-lg-2 col-md-3 col-6 footer-list-29 mt-md-0 mt-4">
                        <ul>
                            ...
                            <li><a href="#become-teacher">Donate</a></li>
                            <li><a href="#">Who We Are </a></li>
                            <li><a href="#career">Testify</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 ps-lg-5 ps-lg-4 footer-list-29 mt-md-0 mt-4">
                        <ul>
                            <h6 class="footer-title-29">Explore</h6>
                            <li><a href="#blog">Our Facebook</a></li>
                            <li><a href="#privacy">Our Youtube</a></li>
                ...
                <!-- copyright -->
                <p class="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">© 2022. All rights reserved. Develoed
                    by <a href="https://..com/" target="_blank">Daniel</a></p>
                <!-- //copyright -->
            </div>
        </div>
    </footer>