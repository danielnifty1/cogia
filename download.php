    ...
    <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title pt-5">Dowloads</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="index.html">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right"></i>Downloads</li>
                </ul>
            </div>
        </div>
    </section>
     ...
     <div class="w3l-grids-block-5 home-course-bg py-5" id="courses">
        <div class="container py-md-5 py-4">
            ...
            <div class="row justify-contend	t-center">
                ...
                $dwnrst=mysqli_query($conn,$getdownloads);
            ...
            <div class="col-md-12">
                ...
                for ($page=1; $page <=$number_of_pages ; $page++) { 
                        echo ' <a class="btn-sm btn-info btn" href="download?page='.$page.'">'.$page.'</a> ';
                    } ?>
                </div>
                </center>
