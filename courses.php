    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="index.html" style="font-size: 12px;text-align: center;"><img style="height: 80px;" src="assets/images/mercy.png">
                    <br>City of God Int'l Assembly
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Givings</a>
                        </li>
