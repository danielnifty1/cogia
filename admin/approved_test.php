		...
		<div class="row"  >
			...
			<div class="table-responsive">
				...
				<table class="table" >
					...
					<?php 
       			//=$_SESSION['adminname'];
							$query = "SELECT* from testimonies where status=1 order by id desc LIMIT ".$page_first_result.','.$result_per_page;
								$result = mysqli_query($conn, $query);//runs the connection to dsatabase and then run the query
				...
				if($return ){
								...
								while ($row = mysqli_fetch_assoc($result)){ 
									...
									<tr id="show<?php echo $id ?>">
										...
										<td>
								  		<button data-toggle="modal" data-target="#exampleModal3<?php echo $id ?>" class="btn btn-success" id="delvifew<?php echo $id ?>">View</button></td>
											
										<td>
								  		<button class="btn btn-danger" id="delview<?php echo $id ?>">DELETE</button></td>
				...
				<script type="text/javascript">
				 ...
				 $("#delview<?php echo $id ?>").click(function(){
				 	 ...
				 	 var testdeleteid = "<?php echo $id ?> ";
				 		...
				 		var retval =confirm("do u want to delete <?php echo $name ?>'s  Testimony");
