            ...
            <div class="col-md-4   col-xs-12 col-sm-12 col-md-push- 2">
              <div class="panel panel-default">
                  <div class="panel-heading">
                       ...
                       <h4 class="wow tada" style="text-align:center;color: dodgerblue;font-weight: bold; margin-top: 5px;padding-top: 15px;">Add Offerring
                        
                      </h4>
                       
                      <h5  class="wow tada" id="msgtext" style="color: dodgerblue;text-align: center;margin-top: 10px; text-transform: lowercase; color: red;">
                    ...
                    <div class="col-md-12  col-xs-12 col-sm-12 ">
                        ...
                        <form id="formb" action="pro.php" method="post">
                            ...
                            <span class="input-group-addon" style="font-weight:bold">
                              <span class="fa fa-udser">Offerring Title</span>
                            </span>
                            <input required onkeypress="offerrings1()"   id="offerrings" name="offerrings"     type="" class="form-control"  placeholder="Enter Offerring"  >
                        	</div>
                          <br>
                          ...
                          <center>
                        <div class="input-group" style="display:noene" id="debtn">
                            
                            <button id="add" class="btn btn-primary btn-sm">ADD</button>
                            <button style="display:none" id="add1" class="btn btn-primary btn-sm">ADD <span class="fa fa-spin fa-spinner"></span></button>
