...
<section id="main-content">
	...
	<section class="wrapper">
		...
		<div class="row"  >
			...
			<h4 style="text-align: center;">New Testimonies (<?php echo $tmember ?>)</h4>		
			...
			<div class="table-responsive">
				...
				<table class="table" >
					...
					<?php 
       			//=$_SESSION['adminname'];
							$query = "SELECT* from testimonies where status=0 order by id desc LIMIT ".$page_first_result.','.$result_per_page;
								$result = mysqli_query($conn, $query);//runs the connection to dsatabase and then run the query
				...
				if($return ){
								...
								while ($row = mysqli_fetch_assoc($result)){ 
										...
										$testimony=base64_decode($testimony)				
									?>
									<tr id="show<?php echo $id ?>">
										...
										<td><?php echo $testifydate ?></td>
										 

										<td><button data-toggle="modal" data-target="#exampleModal3<?php echo $id ?>" class="btn btn-info" id="apprdove<?php echo $id ?>">View</button></td>		
				...
				<script type="text/javascript">
				 ...
				 $("#delview<?php echo $id ?>").click(function(){
				 	 ...
				 	 var testdeleteid = "<?php echo $id ?> ";
				 	
				 		var retval =confirm("do u want to delete <?php echo $name ?>'sv  Testimony");
				...
				//alert(''"');
				  ...
				  $("#approve<?php echo $id ?>").click(function(){

				 	 var approvetest = "<?php echo $id ?> ";
				 	
				 		var retval =confirm("Confirm Approval of <?php echo $name ?>'s Testimony");
				 		...
				 		if(retval==true){
				              ...
				              $.ajax({
				                    ...
				                    data:{
				                      ...
				                      beforeSend: function(){
				                $('#approve<?php echo $id ?>').val("DELETING....");
				              },
				                   success:function(data){
		...
		<div class="row">
			<div class="col-md-12 col-md-push-6 ">
				...
				for ($page=1; $page <=$number_of_pages ; $page++) { 
						echo ' <a class="btn-sm btn-info btn" href="view_test?page='.$page.'">'.$page.'</a> ';
					} ?>
				</div>
