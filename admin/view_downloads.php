...
<section id="main-content">
	...
	<section class="wrapper">
		...
		<div class="row"  >
			...
			<h4 style="text-align: center;">All Downloads</h4>		
				...
				<table class="table" >
					<tr>
						...
						<th>Delete</th>	
							...
							<?php 
		       								//=$_SESSION['adminname'];
									$query = "SELECT* from downloads where status=1 order by id desc LIMIT ".$page_first_result.','.$result_per_page;
										$result = mysqli_query($conn, $query);//runs the connection to dsatabase and then run the query
						...
						if($return ){
								...
								while ($row = mysqli_fetch_assoc($result)){ 
									...
									<tr id="show<?php echo $id ?>">
										...
										<td><a href="../downloads/<?php echo $file ?>" target="_blank">Preview </a></td>
