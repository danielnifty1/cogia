...
<section id="main-content">
	...
	<section class="wrapper">
		...
		<div class="row"  >
			...
			<h4 style="text-align: center;">All Registered Pastors (<?php echo $tmember ?>)</h4>		
				...
				<table class="table" >
					<tr>
						...
						<th>Delete</th>	
							...
							<?php 
		       								//=$_SESSION['adminname'];
									$query = "SELECT* from pastors where status=0 order by id desc";
										$result = mysqli_query($conn, $query);//runs the connection to dsatabase and then run the query
						...
						if($return ){
								...
								while ($row = mysqli_fetch_assoc($result)){ 
									...
									<tr id="show<?php echo $id ?>">
										<td><img src="<?php echo $img ?>" style="width: 50px;height: 50px;border-radius: 100%;"></td>
										<td><?php echo base64_decode($fname) ?></td>
										...
										<td><a href="edithpastor?id=<?php echo $id ?>" class="btn btn-small btn-info">Edith</a></td>		
										<td>
				...
				<script type="text/javascript">
				 ...
				 $("#delview<?php echo $id ?>").click(function(){
				 	 ...
				 	 var viewid = "<?php echo $id ?>";
				 		...
				 		var retval =confirm("do u want to delete <?php echo base64_decode($fname) ?> from pastor's list");
