...
$result_per_page=10;
	...
	// }
	 ...
	 if(!isset($_GET['page'])){
	   ...
	   $getup="SELECT* FROM photos where eventid='$eventid'";
            ...
            <div class="col-md-8   col-xs-12 col-sm-12 col-md-push-2">
              <div class="panel panel-default">
                  <div class="panel-heading">
                       ...
                       <h4 class="wow tada" style="text-align:center;color: dodgerblue;font-weight: bold; margin-top: 5px;padding-top: 15px;"> Upload Photos for <span style="color:orange;"> <?php echo $gname ?> </span>
	                        ...
	                        <input type="hiddden" name="tok" value="<?php echo $da ?>"> -->
	                         <div class="container"  style="margin-top:3px;margin-bottom: 5px; cursor: pointer;">
                              ...
                              <div class="row">
                             		...
                             		<div class="col-md-2">
                              			<input type="file" id='files' name="files[]" multiple style="display: none; visibility: none;"    type="file" accept="image/*">
                          			</div>
                          			</div>
                              		...
                              		<div class="col-md-6 hidden">
	                             	   <div class="input-group">
				                            ...
				                            <input required onkeypress="addnumber1()" value="<?php echo $eventid ?>"   id="eventid" name="eventid"     type="" class="form-control"  placeholder="Middle Name"  >
				                        </div>
                              		</div>
                              		</div>
