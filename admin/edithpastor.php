            ...
            <div class="col-md-8   col-xs-12 col-sm-12 col-md-push-2">
              <div class="panel panel-default">
                  <div class="panel-heading">
                       ...
                       <h4 class="wow tada" style="text-align:center;color: dodgerblue;font-weight: bold; margin-top: 5px;padding-top: 15px;">UPDATE Pastor's Record
                    ...
                    <form id="form" action="pro.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="pid" value="<?php echo $id ?>">
                         <div class="container"  style="margin-top:3px;margin-bottom: 5px; cursor: pointer;">
                              ...
                              <label for="firstimg">
                                <h4>click here</h4>
                                <img id="pv" src="<?php echo $img ?>" style="width:80px;height: 80px;">
                     ...
                     <!-- =  ======================================================================================================== -->
                        ...
                        <form id="formb" action="pro.php" method="post">
                            <input required onkeypress="addnumber1()"   id="pid" name="updatepid" value="<?php echo $id ?>"      type="hidden" class="form-control"  placeholder="First Name"  >
                        <div class="input-group">
                            <span class="input-group-addon" style="font-weight:bold">
                              <span class="fa fa-udser">Name</span>
                            </span>
                            <input required onkeypress="addnumber1()"   id="pastorname" name="updatepastorname"  value="<?php echo base64_decode($fname) ?>"    type="" class="form-control"  placeholder="Full Name"  >
                          </div>
                          <br>

                          <div class="input-group">
                            <span class="input-group-addon" style="font-weight:bold">
                              <span class="fa fa-udser">Phone</span>
                            </span>
                            <input  onkeypress="addnumber1()"   id="postheld" name="updatephone" value="<?php echo $phone ?>"     type="" class="form-control"  placeholder="Post"  >
                        </div>
                          <br>

                          <div class="input-group">
                            <span class="input-group-addon" style="font-weight:bold">
                              <span class="fa fa-udser">email</span>
                            </span>
                            <input  onkeypress="addnumber1()"   id="postheld" name="updatemail" value="<?php echo $email ?>"     type="email" class="form-control"  placeholder="Post"  >
                        </div>
                        <br>
                          ...
                          <div class="input-group">
                            ...
                            <input  onkeypress="addnumber1()"   id="postheld" name="updatepostheld" value="<?php echo $position ?>"     type="" class="form-control"  placeholder="Post"  >
                        </div>
                        <br>
                          <div class="input-group">
                            <span class="input-group-addon" style="font-weight:bold">
                            ...
                            <input  onkeypress="addnumber1()"   id="fb" name="updatefb" value="<?php echo $fb ?>"    type="" class="form-control"  placeholder="Middle Name"  >
                        </div>
                          <br>
                          <div class="input-group">
                            <span class="input-group-addon" style="font-weight:bold">
                            ...
                            <input  onkeypress="addnumber1()"   id="fb" name="updateinstagram" value="<?php echo $instagram ?>"     type="" class="form-control"  placeholder="Middle Name"  >
                        </div>
                          ...
                          <br>
                            ...
                            <input  onkeypress="addnumber1()"   id="twitter" name="updatetwitter" value="<?php echo $twitter ?>"      type="" class="form-control"  placeholder="Middle Name"  >
                        </div>

                          <center>
                        <div class="input-group" style="display:nofne" id="debtn">
                             <h5  class="wow tada mb-4" id="msgtext" style="color: dodgerblue;text-align: center; margin-bottom:15px"><?php
                ...
                if(isset($_GET['msg'])){
                  ...
                  echo $msgs;
                            ...
                            <button id="up" class="btn btn-warning btn-sm mt-5">UPDATE</button>
